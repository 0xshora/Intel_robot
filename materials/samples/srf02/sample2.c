...
int main( void ) {
	...
	if ( ioctl( fd[1], I2C_SLAVE, ( 0xE0 >> 1 ) ) < 0 ) {  // 0xE0(0x11100000) >> 1 = 0x70(0x01110000)
		printf( "Failed get slave address\n" );
		exit( 1 );
	}
	if ( ioctl( fd[2], I2C_SLAVE, ( 0xE0 >> 1 ) ) < 0 ) {  // 0xE0(0x11100000) >> 1 = 0x70(0x01110000)
		printf( "Failed get slave address\n" );
		exit( 1 );
	}
	if ( ioctl( fd[3], I2C_SLAVE, ( 0xE0 >> 1 ) ) < 0 ) {  // 0xE0(0x11100000) >> 1 = 0x70(0x01110000)
		printf( "Failed get slave address\n" );
		exit( 1 );
	}
